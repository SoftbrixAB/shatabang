...
exports.populatesDirectories = populatesDirectories;
exports.checkDirectories = checkDirectories;
const path = __importStar(require("path"));
const shFiles = __importStar(require("./shatabang_files"));
function populatesDirectories(config) {
...
function checkDirectories(config) {
    // Check that directories exists
    if (!config.dirs)
        return;
    Object.values(config.dirs).forEach((directory) => {
